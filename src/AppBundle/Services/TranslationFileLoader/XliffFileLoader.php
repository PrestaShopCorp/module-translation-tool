...
namespace AppBundle\Services\TranslationFileLoader;
 ...
 *
 * This class has been modified to back-port changes from https://github.com/symfony/symfony/pull/29148
 *
        ...
        foreach ($dom->getElementsByTagName('xliff') as $xliff) {
            ...
            if ($namespace) {
                if (substr_compare('urn:oasis:names:tc:xliff:document:', $namespace->nodeValue, 0, 34) !== 0) {
                    throw new InvalidArgumentException(sprintf('Not a valid XLIFF namespace "%s"', $namespace->nodeValue));
                }

                return substr($namespace->nodeValue, 34);
            }
        }
